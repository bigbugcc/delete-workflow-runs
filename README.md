...
## What's new?
* Add the input parameter "[**`keep_minimum_runs`**](#3-keep_minimum_runs)". Whit this input parameter, Enter the minimum number of workflows that need to be retained per workflow, keeping only the most recent workflows (in descending chronological order).
...
#### Required: YES
#### Default: 6
The Each workflow runs minimally to retain.
##
